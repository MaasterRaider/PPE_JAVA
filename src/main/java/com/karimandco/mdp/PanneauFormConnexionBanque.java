 ...
 * @author f.bruckmann
 */
public class PanneauFormConnexionBanque extends javax.swing.JPanel {

    javax.swing.JDialog panneauPereConnexionBanque = null;
...
//    }
     ...
     */
    public PanneauFormConnexionBanque() {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("( 6 à 12 chiffres )");
    ...
    private void jButtonConfirmerConnexionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmerConnexionActionPerformed
        if (panneauIdentifiant.getChamp2().verifIdentifiant() && panneauMdp.getChampSecret1().verifPassword()) {
            ...
            try {
                ...
                Logger.getLogger(PanneauFormConnexionBanque.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            jLabelEtatConnexion.setForeground(Color.red);
    ...
    private void jButton27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton27ActionPerformed
       String recup = panneauMdp.getChampSecret1().getText();
       recup = recup.substring(0, recup.length()-1);
       panneauMdp.getChampSecret1().setText(recup); 
    ...
    public void setFenParentConnexionBanque(javax.swing.JDialog i) {
        this.panneauPereConnexionBanque = i;
    }
    ...
    public void setjButtonConfirmerConnexion(JButton jButtonConfirmerConnexion) {
        this.jButtonConfirmerConnexion = jButtonConfirmerConnexion;
    }
